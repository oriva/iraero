    ...
    switch (number) {
        case 1:
            content = '<div class="popup-content__mob">' +
                ...
                '                    <span class="popup-content__title">Sukhoi Superjet 100 (SSJ100)</span>' +
                '                    <p>Это региональный самолет нового поколения, способный перевозить 98 пассажиров на расстояние до 3000 км ( базовая модель) и до 4500 км ( модификация с увеличенной дальностью). Sukhoi Superjet 100 - единственное семейство самолетов, предлагающее пассажирам уровень комфорта, сопоставимый с магистральными самолетами.<br/><br/>Проект создания Sukhoi Superjet 100 осуществляет ЗАО «Гражданские самолеты Сухого», образованное в 2000 г. Сотрудничество конструкторов из более чем 20 мировых лидеров авиастроения дало возможность наделить самолеты непревзойденными для своего класса характеристиками комфорта и безопасности полета, экономики и эффективности эксплуатации</p>' +
                '                </div>';
            break;
        case 4:
            content = '<div class="popup-content__mob">' +
        ...
        case 5:
            content = '<div class="popup-content__mob">' +
                ...
                '</div>' +
                '<div class="popup-content__padding-v">' +
                '<p><br><br>На центральном пульте пилотов расположен пульт управления двигателями' +
                '<br>Режим работы двигателя контролируется по показаниям индикаторов комплексной системы электронной индикации и сигнализации.<br><br>Автоматическое управление двигателями осуществляется вычислительной системой автомата управления тягой.<br><br>Система фиксаторов обеспечивает исключение самопроизвольного включения режимов работы двигателей.<br><br>Электронная система управления двигателем представляет собой электронную систему с полной ответственностью (FADEC).<br><br>FADEC, взаимодействуя с самолетными системами, обеспечивает оптимальное регулирование режимами двигателя во всех условиях эксплуатации, а также контроль над датчиками и устройствами двигателя с выдачей необходимой информации для индикации в кабине экипажа,выдачу необходимой информации в системы регистрации и технического обслуживания.</p>' +
                ...
                '<br><br>На всех этапах полета предусмотрена возможность автоматического управления двигателями от вычислительной системы автомата управления тягой.' +
                '<br><br><b>Режим APR</b> - При отключении одного из двигателей на взлете электронный блок исправного двигателя по командам комплекса авионики формирует команду на увеличение режима этого двигателя.</p>' +
                '</div>';
            break;
        case 6:
            content =  '<div class="popup-content__mob">' +
                ...
                '                        <br><br>LGSCU - Система управления уборкой и основным выпуском шасси — LGSCU производит контроль и оценку исправности электрических цепей бесконтактных выключателей и контроль работоспособности каналов блока LGSCU.<br>Блок LGSCU — двухканальный. Каждый канал оснащен бесконтактными датчиками положения и обжатия опор шасси.' +
                '                        <br><br><strong>Автоматическая система торможения</strong>' +
                '                        <br><br>После касания взлетно-посадочной полосы, самолёт, без дальнейшего вмешательства, сам начнёт тормозиться с заданным замедлением. Экипаж может отключить автоматику в любой момент времени, простым обжатием педалей.' +
                '                        <br><br>Алгоритм растормаживания срабатывает автоматически, по сигналам датчиков угловой скорости колёс.' +
                '                    </p>' +
                '                </div>';
            break;
        case 9:
            content = '<div class="popup-content__mob">' +
                ...
                '<br><br><strong>Система спутниковой навигации GPS </strong><br>состоит из многорежимного приёмника («Thales Avionics», Франция) и антенны GPS (Chelton, США) и включается при подаче питания на борт самолета.»<br>' +
                '<br><br><strong>Система измерения радиовысоты на SSJ 100 («Thales Avionics», Франция)</strong>' +
                '<br><br>Радиовысотомер предназначен для точного измерения радиовысоты самолета до земли.' +
                '<br><br>Система измерения радиовысоты включается при подаче питания на борт и не может быть выключена из кабины экипажа. Состоит из двух комплектов, которые работают для выдачи данных для левого и правого пилотов.<br>' +
                '</p>' +
                '</div>' +
        ...
        case 13:
            content = '<div class="popup-content__mob">' +
                ...
                '<div class="popup-content__mob-closed"></div>' +
                '</div>' +
                '<img src="img/popup/fire/1.jpg" alt="" class="popup-content__img-100">' +
                '<div class="popup-content__padding-v">' +
                '<span class="popup-content__title">Система пожаротушения</span>' +
                '<p>На самолете установлена система пожаротушения, подающая огнегасящий состав в отсеки двигателей и вспомогательной силовой установки, а также в багажно-грузовые отсеки.' +
                '<br><br>Система сигнализации предупреждает о появлении дыма в салоне; двигателе и багажно-грузовых отсеках.' +
                '<br><br>Система автоматического контроля элементов сигнализации о пожаре и дыме состоит из 5 зон пожароопасности – Вам не о чем беспокоиться.</p>' +
                '<span class="popup-content__title">Ветрогенератор</span>' +
                '<p>В случае отказа обоих генераторов в полёте, RAT выпускается, раскручивается набегающим потоком воздуха и подаёт электропитание на левую и правую бортовые шины. Весь процесс происходит автоматически, однако, имеется и рукоятка для принудительного открытия замка.' +
                '<br><br>Самолет не может быть обесточен в полете, это просто исключено.</p>' +
                '</div>';
            break;
        case 14:
            content = '<div class="popup-content__mob">' +
                ...
                '<div class="popup-content__mob-closed"></div>' +
                '</div>' +
                '<img src="img/popup/distance/1.jpg" alt="" class="popup-content__img-100">' +
                '<div class="popup-content__padding-v">' +
                '<span class="popup-content__title">Система Дистанционного Управления</span>' +
                '<p>Уникальность самолета Sukhoi Superjet 100 в том, что впервые в мире для самолетов такого класса была создана цифровая электродистанционная система управления без тяжелой механической аварийной системы.' +
                '<br><br>Весь полёт на SSJ разбит на 10 последовательных фаз, начиная от включения систем под ток, запуска первого двигателя, вывода на взлётный режим вплоть до прохождения определённого интервала времени после выключения двигателей.</p>' +
                '<span class="popup-content__title">Система метеолокации самолета</span>' +
                '<p>Пилоты воздушного судна с помощью бортовых индикаторов имеют возможность по обнаружению таких природных явлений как: грозы, кучевую облачность, градообразования, интенсивные осадки, турбулентные зоны.' +
                '<br><br>Система метеолокации позволяет получать данные о сдвиге ветра. Алгоритм предупреждения о сдвиге ветра непрерывно осуществляет контроль факторов ветра, которые влияют на рабочие характеристики самолёта, как при взлёте, так и при заходе на посадку.</p>' +
                '</div>';
            break;
    }
...
const popupDots = (() => {
    ...
    const getPosition = [[[41, 43, 1], [172, 143, 2], [44, 71, 3]], [[57, 49, 4], [72, 58, 5], [88, 48, 6]], [[48, 22, 7], [53, 53, 8], [82, 18, 9]], [[70, 35, 15], [94, 48, 14], [26, 24, 13]], [[51, 69, 10], [67, 44, 11], [35, 44, 12]]];
